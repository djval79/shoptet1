                                  ...
                                  <tr key={biz.id} className="hover:bg-slate-700/30 transition-colors">
                                      ...
                                      <td className="p-4">
                                          <span className={`text-[10px] px-2 py-1 rounded uppercase font-bold border ${
                                              biz.subscriptionPlan === 'enterprise' ? 'bg-purple-500/20 text-purple-400 border-purple-500/30' : 
                                      ...
                                      <td className="p-4 text-slate-400 text-xs">
                                          {biz.activeChats} chats
                                      </td>
                                      <td className="p-4">
                                          <span className="flex items-center text-green-400 text-xs">
                                              <span className="w-1.5 h-1.5 rounded-full bg-green-400 mr-2"></span> Active
                                          </span>
                                      </td>
                                      <td className="p-4 text-right font-mono text-white">
                                          ${formData.plans[biz.subscriptionPlan || 'starter']?.price}
                                      </td>
                                  </tr>
                              ))}
                          </tbody>
