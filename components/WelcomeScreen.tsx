...
const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onStartTour, onCreateBusiness, onSkip }) => {
    ...
    return (
        <div className={`fixed inset-0 z-[9999] bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-y-auto ${isExiting ? 'animate-out fade-out duration-300' : 'animate-in fade-in duration-500'}`}>
