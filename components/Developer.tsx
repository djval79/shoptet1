...
const Developer: React.FC<DeveloperProps> = ({ business, logs, webhookLogs, onClearLogs, onSeedData, webhooks = [], onUpdateWebhooks }) => {
  ...
  const generateServerCode = () => {
      ...
      return `
/**
 * TwilioFlow Auto-Generated Server for ${business.name}
              ...
              <div className="p-6 flex-1 flex flex-col">
                  <div className="flex justify-between items-center mb-6">
                      <div>
                         ...
                         <p className="text-xs text-slate-400">Notify external systems when events happen in TwilioFlow.</p>
                      </div>
              ...
              <div className="flex flex-1 overflow-hidden">
                  ...
                  <div className="flex-1 p-8 overflow-y-auto custom-scrollbar">
                      ...
                      <p className="text-slate-400 mb-6 leading-relaxed">
                          Welcome to the TwilioFlow Developer API. This platform allows you to programmatically manage your WhatsApp AI agents, 
