...
const Onboarding: React.FC<OnboardingProps> = ({ onComplete, onCancel }) => {
    ...
    const handleSubmit = () => {
        ...
        const newBusiness: BusinessProfile = {
            ...
            sandboxConfig: {
                incomingUrl: `https://api.chat2close.ai/v1/webhooks/whatsapp/${newBusinessId}/incoming`,
                statusCallbackUrl: `https://api.chat2close.ai/v1/callbacks/status/${newBusinessId}`,
                fallbackUrl: ''
            },
            aiConfig: {
